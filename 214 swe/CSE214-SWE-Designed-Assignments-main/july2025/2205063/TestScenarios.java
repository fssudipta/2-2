public class TestScenarios {
    public static void main(String[] args) {
        ...
        System.out.println("CSE101 initial: status=" + cse101.status + " enrolled=" + cse101.getEnrolledCount()
                + " cap=" + cse101.getCapacity());
        ...
        System.out
                .println("NOTE: In interactive mode, admin is prompted to increase capacity when closing FULL course.");
        ...
        bob.enrollIn(cse250);
        System.out.println("CSE250 status: " + cse250.status + " (enrolled=" + cse250.getEnrolledCount() + ", cap="
                + cse250.getCapacity() + ")");
        ...
        System.out.println("CSE201 before: enrolled=" + cse201.getEnrolledCount() + " cap=" + cse201.getCapacity()
                + " status=" + cse201.status);
        ...
        System.out.println("CSE220 before: enrolled=" + cse220.getEnrolledCount() + " cap=" + cse220.getCapacity()
                + " status=" + cse220.status);
