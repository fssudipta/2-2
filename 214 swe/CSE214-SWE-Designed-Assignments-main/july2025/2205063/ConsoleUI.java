...
public class ConsoleUI {
    ...
    private void listAvailableCourses() {
        ...
        for (Course c : registrar.getAllCourses()) {
            if (c.isVisibleToStudents()) {
                System.out
                        .println("  " + c.code + " - " + c.title + " | status=" + c.status + " | cap=" + c.getCapacity()
                                + " | enrolled=" + c.getEnrolledCount() + " | waitlist=" + c.getWaitlistCount());
            }
        }
    }
    ...
    private void listAllCourses() {
        ...
        for (Course c : registrar.getAllCourses()) {
            System.out.println("  " + c.code + " - " + c.title + " | status=" + c.status + " | cap=" + c.getCapacity()
                    + " | enrolled=" + c.getEnrolledCount() + " | waitlist=" + c.getWaitlistCount());
        }
    }
}
